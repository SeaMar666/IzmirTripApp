...
public class Museum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<ancient> options = new FirebaseRecyclerOptions.Builder<ancient>().setQuery(FirebaseDatabase.getInstance().getReference().child("Museums"), ancient.class).build();
        adapter = new mymuseumadapter(options);
